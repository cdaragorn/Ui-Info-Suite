    ...
    class ShowCalendarAndBillboardOnGameMenuButton : IDisposable
    {
        ...
        private void OnRenderedActiveMenu(object sender, EventArgs e)
        {
                ...
                && _heldItem.Value == null)
            {
                ...
                billboardButton.bounds.Y = Game1.activeClickableMenu.yPositionOnScreen + Game1.activeClickableMenu.height - (_helper.ModRegistry.IsLoaded("spacechase0.BiggerBackpack") ? 230 : 300);
